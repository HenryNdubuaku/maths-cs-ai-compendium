...
1. Write a C++ program that quantises float32 weights to INT8 and measures the compression ratio and quantisation error.
...
1. Write a C++ program that performs INT8 matrix multiplication with INT32 accumulation — the actual computation that runs on embedded ML accelerators.
