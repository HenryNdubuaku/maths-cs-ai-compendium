...
1. Write a tiled matrix multiply in CUDA using shared memory. Compare the performance against a naive (non-tiled) version. This teaches shared memory, `__syncthreads`, and why tiling matters.
...
1. Demonstrate warp divergence. Write a kernel where threads in the same warp take different branches, and compare against a branchless version.
