...
1. Compute Pearson and Spearman correlation between two variables. Experiment with different relationships.
...
1. Implement outlier detection using both the IQR and z-score methods, then compare their results on skewed data.
...
1. Compute and plot an Exponential Moving Average with different smoothing factors on noisy data.
