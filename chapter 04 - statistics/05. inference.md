...
1. Estimate $\pi$ using Monte Carlo simulation. Plot how the estimate converges as you increase the number of points.
...
1. Perform a simple power analysis: for a given effect size and standard deviation, compute the required sample size and verify it by simulation.
...
1. Visualise how confidence interval width changes with sample size. This shows why collecting more data gives more precise estimates.
