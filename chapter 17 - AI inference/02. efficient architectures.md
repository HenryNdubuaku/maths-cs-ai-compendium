...
1. Compare the KV-cache size for MHA, GQA, and MQA. Show why GQA is the practical sweet spot.
...
1. Simulate structured pruning by removing the least important attention heads from a random attention layer and measuring the output change.
