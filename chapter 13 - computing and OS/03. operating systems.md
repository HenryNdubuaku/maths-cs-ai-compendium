...
1. Simulate round-robin scheduling. Given a list of processes with burst times, simulate the scheduling and compute average waiting time.
...
1. Simulate page replacement with LRU. Given a sequence of page accesses and a fixed number of frames, count page faults.
