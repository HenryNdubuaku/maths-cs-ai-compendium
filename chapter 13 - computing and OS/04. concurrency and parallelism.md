...
1. Fix the race condition with a lock and measure the overhead.
...
1. Visualise Amdahl's law. Plot speedup vs number of processors for different parallel fractions.
