...
1. Simulate a direct-mapped cache. Track hits and misses for a sequence of memory accesses.
...
1. Demonstrate why floating-point arithmetic is not associative. Show cases where $(a + b) + c \neq a + (b + c)$.
