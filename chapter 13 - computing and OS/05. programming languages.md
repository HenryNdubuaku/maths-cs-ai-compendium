...
1. Compare dynamic vs static typing behaviour. Show how Python's dynamic typing allows flexibility but can hide bugs.
...
1. Measure the performance difference between interpreted Python and compiled/JIT approaches for a compute-heavy task.
