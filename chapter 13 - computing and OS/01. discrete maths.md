...
1. Prove the sum formula by induction -- numerically verify for many values, then implement the closed-form solution.
...
1. Solve the merge sort recurrence using the Master Theorem and verify empirically by counting operations.
