...
1. Simulate a constant-velocity motion prediction model and compare with ground truth for a turning vehicle.
...
1. Implement a simple rule-based planner that decides between lane-keeping and stopping based on detected obstacles.
