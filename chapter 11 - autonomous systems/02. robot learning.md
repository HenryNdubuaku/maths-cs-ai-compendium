...
1. Implement inverse kinematics using the Jacobian pseudo-inverse. Start from a random configuration and iteratively move the end-effector to a target.
...
1. Simulate a simple PID controller tracking a desired joint trajectory. Observe the effect of tuning the gains.
